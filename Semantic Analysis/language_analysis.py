...
# Save both tables
grouped_risk.to_csv("unicredit/Semantic_Analysis_by_Risk_Distress.csv", index=False)
grouped_coverage.to_csv("unicredit/Semantic_Analysis_by_Answer_Coverage.csv", index=False)
